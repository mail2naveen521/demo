...
# detect_drift.py takes no arguments, so wsadmin sets sys.argv = []
# When imported by manage_drift.py, sys.argv[0] will be the manage command
# (e.g. "status", "update-baseline") - so we know we are being imported.
if len(sys.argv) == 0:
    run_drift_check()
