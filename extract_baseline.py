...
# Only run _main() when executed directly via wsadmin -f extract_baseline.py
# Importers (detect_drift.py, manage_drift.py) set this key in sys.modules
# BEFORE the import statement so this check sees it correctly.
if "_drift_importing" not in sys.modules:
    _main()
